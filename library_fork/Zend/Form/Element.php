...
class Zend_Form_Element implements Zend_Validate_Interface
{
     ...
     * @var bool
     */
    protected $_allowBrackets = false;
    ...
    /**
     * Set 'allow brackets' flag
     *
     * When the allow brackets flag is enabled
     * the square brackets - aka array syntax - will be 
     * allowed in form-field names
     *
     * @param  bool $flag
     * @return Zend_Form_Element
     */
    public function setAllowBrackets($flag)
    {
        $this->_allowBrackets = (bool) $flag;
        return $this;
    }
